...
# include("RelocatableSimulation.jl")
...
#     architecture::A # empty GPU or CPU struct
#     device # the actual CUDA device or the CPU
...
#     normalVelocityNew::AbstractArray{F} where F <: AbstractFloat # normVel in 1 timestep
